<<<<<<< HEAD:jays_scrapers/pearl_scraper_v3.py
=======
...
with open('jdatap3.csv', 'a', newline='') as file:  
    ...
    #print ("writing_pearl V3")
>>>>>>> parent of 1468c36... Includes Google API to write to gsheets:optical_character_recognition_testing/pearl_scraper_v3.py
